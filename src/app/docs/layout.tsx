...
export default function DocsLayout({ children }: { children: ReactNode }) {
  return (
    <div className="relative min-h-screen bg-[radial-gradient(1200px_700px_at_10%_-10%,#2a2b52_0%,transparent_60%),radial-gradient(900px_600px_at_85%_10%,#1b1238_0%,transparent_55%),linear-gradient(180deg,#0a0a14_0%,#120c26_55%,#0a0a14_100%)] text-[var(--foreground)]">
      ...
      <main className="relative mx-auto grid w-full max-w-6xl min-w-0 gap-6 px-6 pb-20 pt-10 lg:h-[calc(100dvh-88px)] lg:grid-cols-[260px_1fr] lg:pb-6 lg:pt-6">
        <DocsSidebar />
        <div className="min-w-0 rounded-3xl border border-white/10 bg-white/5 p-6 md:p-8 lg:min-h-0 lg:overflow-y-auto">
          {children}
        </div>
      </main>
    </div>
